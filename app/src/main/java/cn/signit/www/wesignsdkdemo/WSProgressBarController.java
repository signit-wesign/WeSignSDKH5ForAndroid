...
public class WSProgressBarController {

    private WSTimer loadingProgressBarTimer;
    ...
    public WSProgressBarController(ControllerListener listener) {
        mListener = listener;
        init();
    }
    ...
    void init() {
        ...
        loadingProgressBarTimer = new WSTimer(new WSTimer.OnListener() {
